  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-b from-white via-gray-50 to-white">
      ...
      <main className="flex-grow">
        ...
        <section id="business-segments" className="py-16 md:py-28 relative overflow-hidden">
        ...
        <section id="solutions" className="py-16 md:py-28 bg-gradient-to-br from-gray-50 to-white relative overflow-hidden">
        ...
        <section id="about-us" className="py-16 md:py-28 relative overflow-hidden">
        ...
        <section id="clients" className="py-16 md:py-28 bg-gradient-to-b from-gray-50 to-white relative overflow-hidden">
          {/* Modern tech-inspired background elements */}
          <div className="absolute inset-0 tech-pattern-grid opacity-5"></div>
